mb_debug_makefile ?= $(if $(value mb_debug),$(mb_debug),0)
...
ifeq ($(mb_debug_makefile),1)
$(warning WARNING: MakeBind is not found in $(mb_mb_default_path))
endif
...
ifneq ($(mb_silent_mode),1)
	...
	$(error ERROR: MakeBind is not present in the project, please downloadt it and place it in $(mb_mb_default_path))
