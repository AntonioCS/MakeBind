...
php/lv/ar/run/%: ## Run artisan command. Replace <cmd> with the command. Ex.: make php/lv/ar/run/migrate. Use ar_opts option to pass additional options. Ex.: make lv/ar/run/migrate ar_opts="--env=testing"
	$(eval cmd := $(subst /, ,$*))
	$(eval params := )
	$(if $(word 2, $(cmd)),
...
php/lv/ar/help/%: ## Get help for this artisan command. Replace <cmd> with the command you want to get help for. Ex.: make lv/ar/help/migrate
...
php/lv/ar/list/%: ## List all artisan commands but filter by <filter>. Replace <filter> with the filter you want to use. Ex.: make lv/ar/list/migrate
