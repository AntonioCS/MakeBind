...
tests/core/util/cache_write_and_read:
	...
	$(call mb_assert_file_exists,$(mb_cache_folder_path)/cache_write_test.$(mb_cache_file_extension))
...
tests/core/util/cache_write_ttl:
	...
	$(call mb_assert_file_exists,$(mb_cache_folder_path)/cache_write_test_ttl.$(mb_cache_file_extension))
	$(call mb_assert_file_exists,$(mb_cache_folder_path)/cache_write_test_ttl.$(mb_cache_ttl_extension))
